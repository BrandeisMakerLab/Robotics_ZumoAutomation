/* This is our modified example code.
*/
...
void loop()
{
  ...
  if (sensor_values[0] > QTR_THRESHOLD) //Changed "<" to ">" so that it can work on a white table and black line
  {
    // if leftmost sensor detects line, reverse and turn to the right
    turn(RIGHT, true);
  }
  else if (sensor_values[5] > QTR_THRESHOLD) //Changed "<" to ">" so that it can work on a white table and black line
  {
