...
//runs teh website and returns a string representing what he user will do
String runWebsite(){
...
int displayBody(WiFiClient client) {
  ...
  client.println("<p><a href=\"/" + nextCodes[index] + "\"><button class=\"button button2\">" +  nextCodes[index] + "</button></a></p>");
  Serial.println("I should do " + possibleCodes[index]);
  return index;
}
