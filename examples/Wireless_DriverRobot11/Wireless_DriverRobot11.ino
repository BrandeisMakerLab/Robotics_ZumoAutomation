...
void displayWebsite(WiFiClient client) {
...
void displayBody(WiFiClient client) {
  //String test="driveF";
  //Serial.println(hasLink("driveF"));
  ...
  client.println("<p><a href=\"/" + possibleCodes[index] + "\"><button class=\"button button2\">" +  nextCodes[index] + "</button></a></p>");
  Serial.println("I should do " + nextCodes[index]);
}
