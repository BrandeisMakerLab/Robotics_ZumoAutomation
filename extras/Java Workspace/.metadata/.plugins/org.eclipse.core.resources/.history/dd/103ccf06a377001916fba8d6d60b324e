...
public class MiniScanner{
	...
	*/
	...
	/**
	 * helper method
	 * iterates along the base string to get the next piece
	...
	private boolean getNextString(){
		...
		if (hasNextToken){
			...
			//but say that already checked is true, becuase there are no more strings to return
