...
public class ArduinoClassH extends ArduinoClassMaster{
	...
	*/
	...
	public ArduinoClassH(String className,String author,String organization,String headerComments,String supportedBoards,String variables,String privateMethods,String publicMethods){
		...
		init(className,supportedBoards,variables,privateMethods,publicMethods);
	}
	
	/**Creates a new ArduinoClassH object from necessary strings containing information like supported boards and author name
	* with hardcoded date for testing purposes
	 * */
	public ArduinoClassH(String className,String author,String organization,boolean hardCodeDate,String headerComments,String supportedBoards,String variables,String privateMethods,String publicMethods){
		//call super constructor to create header comment
	...
	/**
	 * Helper method to initialize class and allow more flexibility with constructors
	 */
	private void init(String className,String supportedBoards,String variables,String privateMethods,String publicMethods){
