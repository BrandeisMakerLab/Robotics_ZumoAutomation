/*Brnadeis Robotics Club Porte Library to allow for board indepndence*/



/*! \file GenReflectanceSensorArray.h
 *
 * See the GenReflectanceSensorArray class reference for more information about
 * this library.
 *
 * \class GenReflectanceSensorArray GenReflectanceSensorArray.h
 * \brief Read from reflectance sensor array
 *
 * GenReflectanceSensorArray provides an interface for using a
 ...
 * ### Calibration ###
 *
 * GenReflectanceSensorArray allows you to use the `calibrate()`
 ...
 *
 *
 * GenReflectanceSensorArray gives you a number of different ways to
 * read the sensors.
 *
 ...
 * ### Class inheritance ###
 *
 * The GenReflectanceSensorArray class is derived from the QTRSensorsRC class,
 ...
 * for this library.
 *
 * We recommend using GenReflectanceSensorArray instead of
...
#ifndef GenReflectanceSensorArray_h
#define GenReflectanceSensorArray_h
...
class GenReflectanceSensorArray : public QTRSensorsRC
{
  public:
   ...
   */
  GenReflectanceSensorArray(unsigned char emitterPin)
  {
    init(emitterPin);
  }
   ...
   * settings as given.
   */
  GenReflectanceSensorArray(unsigned char * pins, unsigned char numSensors, unsigned int timeout = 2000,
   ...
   * \param emitterPin Pin that turns IR emitters on or off.
   *
   * This function initializes the GenReflectanceSensorArray object with the
  ...
  void init(unsigned char emitterPin = ZUMO_SENSOR_ARRAY_DEFAULT_EMITTER_PIN)
  {
		...
		// Arduino UNO and other ATmega328P/168 Arduinos
		//those pins don't exist on arduino
		unsigned char sensorPins[] = { 4, 30, 13, A0,30, 14 };
	#endif
   ...
   * \param emitterPin Pin that turns IR emitters on or off.
   *
   * This function initializes the GenReflectanceSensorArray object with all
   * settings as given.
   *
   ...
   *
   * ~~~{.ino}
   * GenReflectanceSensorArray reflectanceSensors;
   *
   * ...
   *
   ...
   * ~~~
   *
   * Alternatively, you can use \ref GenReflectanceSensorArray(unsigned char * pins, unsigned char numSensors, unsigned int timeout, unsigned char emitterPin)
   * "a different constructor" to declare and initialize the object at the same
   * time:
   *
   * ~~~{.ino}
   *
   * GenReflectanceSensorArray reflectanceSensors((unsigned char[]) {4, 5}, 2);
   * ~~~
   *
   */
...
\memberof GenReflectanceSensorArray
 ...
 * jumper or otherwise).
 *
 * The GenReflectanceSensorArray class inherits this function from the
 * QTRSensors class.
 */
 ...
 *
 * The GenReflectanceSensorArray class inherits this variable from the
 * QTRSensors class.
 *
